...
public class SqmlIssueInvalidValueReference extends AbstractSqmlError<ISqmlValueReference> {

	public SqmlIssueInvalidValueReference(ISqmlValueReference valueReference) {
