...
public class SqmlIssueParameterReferenceNotCollection extends AbstractSqmlError<ISqmlStaticVariableReference> {

	public SqmlIssueParameterReferenceNotCollection(ISqmlStaticVariableReference parameterReference) {
	...
	public String getMessage() {
		...
		return "Parameter reference must be a collection.";
	}
}
