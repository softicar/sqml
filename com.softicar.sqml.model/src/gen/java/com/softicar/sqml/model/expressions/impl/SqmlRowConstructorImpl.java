...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sqml Row Constructor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.softicar.sqml.model.expressions.impl.SqmlRowConstructorImpl#isExplicit <em>Explicit</em>}</li>
 *   <li>{@link com.softicar.sqml.model.expressions.impl.SqmlRowConstructorImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SqmlRowConstructorImpl extends MinimalEObjectImpl.Container implements SqmlRowConstructor {
	/**
	 ...
	 * @generated
	 */
	protected SqmlRowConstructorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.Literals.SQML_ROW_CONSTRUCTOR;
	}
	...
	public void setExplicit(boolean newExplicit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.SQML_ROW_CONSTRUCTOR__EXPLICIT, oldExplicit, explicit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExpressionsPackage.SQML_ROW_CONSTRUCTOR__EXPRESSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionsPackage.SQML_ROW_CONSTRUCTOR__EXPLICIT:
				return isExplicit();
			case ExpressionsPackage.SQML_ROW_CONSTRUCTOR__EXPRESSIONS:
